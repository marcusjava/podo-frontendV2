  ...
  return loading ? (
    ...
    <div className="page">
      ...
      <div className="consult-container">
        <p>
          <strong>
            Data/Hora:{dayjs(consult.date).format("DD/MM/YYYY HH:mm")}
          </strong>
        </p>
        ...
        <div className="anamnese-items">
          <p>
            ...
            {consult.anamnese.esporte.option === true ? "Sim" : "Não"} Qt:{" "}
          ...
          <p>
            ...
            {consult.anamnese.calcado.tipo} Material:{" "}
            {consult.anamnese.calcado.material}
          </p>
          <p>
            <strong>
              Medicamento:{" "}
              {consult.anamnese.medicamento.option === true ? "Sim" : "Não"} -{" "}
              {consult.anamnese.medicamento.description}
            </strong>
          </p>
          <p>
            <strong>Alergia:</strong>{" "}
            {consult.anamnese.alergia.option === true ? "Sim" : "Não"} -{" "}
            {consult.anamnese.alergia.description}
          </p>
          <p>
            <strong>Doença:</strong>{" "}
            {consult.anamnese.doenca.option === true ? "Sim" : "Não"} -{" "}
